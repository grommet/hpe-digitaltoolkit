...
export default class MarqueeParallax extends Component {
  ...
  _handleScroll () {
    ...
    let marqueeText = marqueeNode.getElementsByClassName('marquee-parallax__overlay')[0];
  ...
  render () {
    ...
    return (
      <Box className={classes} colorIndex={this.state.colorIndex}>
        ...
        <Box className="marquee-parallax__overlay" justify={justify} align="center" primary={true} full={full} direction="row" >
